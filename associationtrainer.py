    ...
    if word != target:
        ...
        with connection:
            ...
            if SQLReturn:
                ...
                with connection:
                    cursor.execute('INSERT INTO associationmodel(word, association_type, target, weight) VALUES (?, ?, ?, ?);', (word.encode('utf-8', 'ignore'), associationType, target.encode('utf-8', 'igno